document.addEventListener('DOMContentLoaded', function () {
    ...
    if (document.querySelector('.open-color-popup-btn')) {
        const colorPopup = document.querySelector('.color-popup');
        const chooseColorBtns = document.querySelectorAll('.open-color-popup-btn');
